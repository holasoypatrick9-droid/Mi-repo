...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Hola mi amor, a pesar de que se me es un poco complejo decir lo q siento, usted sabe q la quiero mucho y q el me ande peleando cada q puede pq se le hace divertido me incentiva a querer verla y jalarle las orejas, que ojalá y no sea en un tiempo muuy lejano, ambos estamos desarrollando mucha paciencia, vistes vistes`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con todo el cariño del mundo, Samu";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-10-26T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-10-26T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Llevamos siendo serios: <b>${days}</b> días<br>` +
      `Nuestro aniversario siendo serios: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
